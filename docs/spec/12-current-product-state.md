...
| Design system (SoT)? | [`DESIGN.md`](../../DESIGN.md) — [#8](https://github.com/hoanghonghuy/filvault/issues/8) IN_PROGRESS → PR [#54](https://github.com/hoanghonghuy/filvault/pull/54) open (MERGEABLE vs `develop`; shell-language recon với AppShell three-form-factor contract #48; chờ exact-head required CI + human review) |
...
| **Themes & settings** — dark/system, color themes, Theme Center | Có (cơ bản; free-only UI [#56](https://github.com/hoanghonghuy/filvault/pull/56) / [#17](https://github.com/hoanghonghuy/filvault/issues/17)) | [#15](https://github.com/hoanghonghuy/filvault/issues/15), [#14](https://github.com/hoanghonghuy/filvault/issues/14), [#34](https://github.com/hoanghonghuy/filvault/issues/34), [#36](https://github.com/hoanghonghuy/filvault/issues/36) IN_PROGRESS → PR [#57](https://github.com/hoanghonghuy/filvault/pull/57) (MERGEABLE vs `develop`; `auth.user` canonicality đã xử lý trên PR — PATCH response only, unsaved edits giữ trong SettingsView-local refs; chờ exact-head required CI + human review) | Chưa |
...
| Design system đồng bộ surfaces hiện tại | Chưa | [#8](https://github.com/hoanghonghuy/filvault/issues/8) IN_PROGRESS → PR [#54](https://github.com/hoanghonghuy/filvault/pull/54) open (MERGEABLE vs `develop`; shell-language recon với AppShell three-form-factor contract #48; chờ exact-head required CI + human review) |
...
| PR | Issue | Mô tả ngắn |
|---|---|---|
| [#54](https://github.com/hoanghonghuy/filvault/pull/54) | [#8](https://github.com/hoanghonghuy/filvault/issues/8) | DESIGN.md reconcile (open; MERGEABLE vs `develop`; chờ exact-head required CI + human review) |
| [#57](https://github.com/hoanghonghuy/filvault/pull/57) | [#36](https://github.com/hoanghonghuy/filvault/issues/36) | Settings section-scoped save (open; MERGEABLE vs `develop`; `auth.user` canonicality đã xử lý trên PR; chờ exact-head required CI + human review) |
| [#49](https://github.com/hoanghonghuy/filvault/pull/49) | [#43](https://github.com/hoanghonghuy/filvault/issues/43) | Release smoke — **PARKED** on external Docker runtime evidence (draft; **CONFLICTING** vs `develop`; không merge-ready) |
