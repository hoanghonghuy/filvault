...
| Design system (SoT)? | [`DESIGN.md`](../../DESIGN.md) — [#8](https://github.com/hoanghonghuy/filvault/issues/8) IN_PROGRESS → PR [#54](https://github.com/hoanghonghuy/filvault/pull/54) open (behind `develop`; reconciling; shell-language recon với AppShell #48) |
...
| **Themes & settings** — dark/system, color themes, Theme Center | Có (cơ bản; free-only UI [#56](https://github.com/hoanghonghuy/filvault/pull/56) / [#17](https://github.com/hoanghonghuy/filvault/issues/17)) | [#15](https://github.com/hoanghonghuy/filvault/issues/15), [#14](https://github.com/hoanghonghuy/filvault/issues/14), [#34](https://github.com/hoanghonghuy/filvault/issues/34), [#36](https://github.com/hoanghonghuy/filvault/issues/36) IN_PROGRESS → PR [#57](https://github.com/hoanghonghuy/filvault/pull/57) (behind `develop`; blocking TL/QA: `auth.user` canonicality sau section save) | Chưa |
...
| Design system đồng bộ surfaces hiện tại | Chưa | [#8](https://github.com/hoanghonghuy/filvault/issues/8) IN_PROGRESS → PR [#54](https://github.com/hoanghonghuy/filvault/pull/54) open (behind `develop`; reconciling); shell-language recon với AppShell three-form-factor (#48) |
...
| PR | Issue | Mô tả ngắn |
|---|---|---|
| [#54](https://github.com/hoanghonghuy/filvault/pull/54) | [#8](https://github.com/hoanghonghuy/filvault/issues/8) | DESIGN.md reconcile (open; **behind** `develop` — reconciling) |
| [#57](https://github.com/hoanghonghuy/filvault/pull/57) | [#36](https://github.com/hoanghonghuy/filvault/issues/36) | Settings section-scoped save (open; **behind** `develop`; blocking TL/QA: `auth.user` canonicality after section save — fix in flight; **not merge-ready**) |
...
Nhóm **release / repository integrity:** [#43](https://github.com/hoanghonghuy/filvault/issues/43) **PARKED** → PR [#49](https://github.com/hoanghonghuy/filvault/pull/49) (external Docker runtime evidence; behind `develop`); [#50](https://github.com/hoanghonghuy/filvault/issues/50) IN_PROGRESS (ruleset `22665159` — 5 required checks incl. E2E documented here; close after handoff #47 + human); epic [#4](https://github.com/hoanghonghuy/filvault/issues/4)

Nhóm **shell & cross-cutting:** [#8](https://github.com/hoanghonghuy/filvault/issues/8) IN_PROGRESS → PR [#54](https://github.com/hoanghonghuy/filvault/pull/54) (behind `develop`; reconciling; shell-language recon: ≤767 bottom nav; 768–1023 80px icon rail + page header; ≥1024 220px expanded sidebar — contract #48); [#16](https://github.com/hoanghonghuy/filvault/issues/16), [#35](https://github.com/hoanghonghuy/filvault/issues/35)

Nhóm **theo surface (design):** [#36](https://github.com/hoanghonghuy/filvault/issues/36) IN_PROGRESS → PR [#57](https://github.com/hoanghonghuy/filvault/pull/57) (behind `develop`; blocking TL/QA gate on `auth.user` canonicality — **not merge-ready**); [#21](https://github.com/hoanghonghuy/filvault/issues/21)–[#35](https://github.com/hoanghonghuy/filvault/issues/35) — chi tiết AC trên từng issue
