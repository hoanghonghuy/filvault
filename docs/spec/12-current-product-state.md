...
| Design system (SoT)? | [`DESIGN.md`](../../DESIGN.md) — [#8](https://github.com/hoanghonghuy/filvault/issues/8) IN_PROGRESS → PR [#54](https://github.com/hoanghonghuy/filvault/pull/54) open (CONFLICTING vs `develop`; reconciling sau #59; chờ Designer/QA — không self-merge) |
...
| **Themes & settings** — AppearanceMode system/light/dark, accent themes, Theme Center | Có (canonical appearance [#59](https://github.com/hoanghonghuy/filvault/pull/59) / [#15](https://github.com/hoanghonghuy/filvault/issues/15); free-only UI [#56](https://github.com/hoanghonghuy/filvault/pull/56) / [#17](https://github.com/hoanghonghuy/filvault/issues/17)) | [#14](https://github.com/hoanghonghuy/filvault/issues/14), [#34](https://github.com/hoanghonghuy/filvault/issues/34), [#36](https://github.com/hoanghonghuy/filvault/issues/36) IN_PROGRESS → PR [#57](https://github.com/hoanghonghuy/filvault/pull/57) (reconciled onto `develop`; `auth.user` canonicality đã xử lý — PATCH response only, unsaved edits giữ trong SettingsView-local refs; chờ human review) | Chưa |
...
| Protected integration branches + required PR quality gates + review-thread resolution | **Enforced** | Ruleset [22665159](https://github.com/hoanghonghuy/filvault/rules/22665159); [#50](https://github.com/hoanghonghuy/filvault/issues/50) **closed** |
...
| Design system đồng bộ surfaces hiện tại | Chưa | [#8](https://github.com/hoanghonghuy/filvault/issues/8) IN_PROGRESS → PR [#54](https://github.com/hoanghonghuy/filvault/pull/54) open (CONFLICTING vs `develop`; reconciling sau #59; shell-language recon với AppShell three-form-factor contract #48; chờ Designer/QA review) |
...
Ruleset contract above enforced via [#50](https://github.com/hoanghonghuy/filvault/issues/50) (closed). Handoff doc PR [#47](https://github.com/hoanghonghuy/filvault/pull/47) / [#39](https://github.com/hoanghonghuy/filvault/issues/39) remains draft until PM undraft.
...
| [#54](https://github.com/hoanghonghuy/filvault/pull/54) | [#8](https://github.com/hoanghonghuy/filvault/issues/8) | DESIGN.md reconcile (CONFLICTING vs `develop`; reconciling sau #59; chờ Designer/QA — không self-merge) |
...
Nhóm **release / repository integrity:** [#43](https://github.com/hoanghonghuy/filvault/issues/43) **PARKED** → PR [#49](https://github.com/hoanghonghuy/filvault/pull/49) (draft; behind `develop`; cần reconcile; Docker-host evidence gate — CI xanh không đủ để undraft); [#50](https://github.com/hoanghonghuy/filvault/issues/50) **closed** (ruleset `22665159` active); epic [#4](https://github.com/hoanghonghuy/filvault/issues/4)

Nhóm **shell & cross-cutting:** [#8](https://github.com/hoanghonghuy/filvault/issues/8) IN_PROGRESS → PR [#54](https://github.com/hoanghonghuy/filvault/pull/54) (CONFLICTING vs `develop`; reconciling sau #59; shell-language recon: ≤767 bottom nav; 768–1023 80px icon rail + page header; ≥1024 220px expanded sidebar — contract #48; chờ Designer/QA review); [#16](https://github.com/hoanghonghuy/filvault/issues/16), [#35](https://github.com/hoanghonghuy/filvault/issues/35)

Nhóm **theo surface (design):** [#36](https://github.com/hoanghonghuy/filvault/issues/36) IN_PROGRESS → PR [#57](https://github.com/hoanghonghuy/filvault/pull/57) (reconciled onto `develop`; `auth.user` canonicality đã xử lý — removed `mergeUserAfterSectionSave`, `auth.user` = PATCH response only, unsaved edits trong SettingsView-local refs; chờ human review); READY P1 design backlog: [#14](https://github.com/hoanghonghuy/filvault/issues/14), [#16](https://github.com/hoanghonghuy/filvault/issues/16), [#22](https://github.com/hoanghonghuy/filvault/issues/22)–[#34](https://github.com/hoanghonghuy/filvault/issues/34) — chi tiết AC trên từng issue
...
- Branch protection / required CI / review-thread resolution ([#50](https://github.com/hoanghonghuy/filvault/issues/50)) — **đã enforced** qua ruleset `22665159` (incl. `Web — E2E critical path` + `required_review_thread_resolution`); issue **closed**. Không tái cấu hình thủ công trừ khi đổi contract.
