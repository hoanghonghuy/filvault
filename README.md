...
**Merge vào `develop`/`main`:** PR bắt buộc + 5 required CI checks (incl. E2E) — xem [Hợp đồng merge](docs/spec/12-current-product-state.md#hợp-đồng-merge-pr--developmain) trong doc 12.
