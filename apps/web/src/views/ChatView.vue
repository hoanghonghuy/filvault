...
const apiErrorCopy = computed(() => chatApiErrorCopy(locale.value).apiError)
...
async function loadPersonalPhotos() {
  ...
  try {
    ...
    personalPhotosError.value = formatApiError(e, t.value.personalPhotosLoadError, apiErrorCopy.value)
  } finally {
...
async function performInfoSearch() {
  ...
  try {
    ...
    error.value = formatApiError(e, t.value.chatSearchFailed, apiErrorCopy.value)
  } finally {
...
async function selectReaction(emoji: string, targetMessage?: ChatMessage) {
  ...
  try {
    ...
    ui.showToast(formatApiError(err, t.value.reactionFailed, apiErrorCopy.value), 'error')
  }
}
...
async function toggleActiveStatus() {
  ...
  try {
    ...
    ui.showToast(formatApiError(e, t.value.activeStatusUpdateError, apiErrorCopy.value), 'error')
  }
}
...
async function loadConversations() {
  ...
  try {
    ...
    error.value = formatApiError(e, t.value.chatLoadFailed, apiErrorCopy.value)
  } finally {
    loading.value = false
  }
}
...
async function createDirectConversation(email: string) {
  ...
  try {
    ...
    error.value = formatApiError(e, t.value.chatOpenDirectFailed, apiErrorCopy.value)
  }
}
...
async function loadMessages(id = selectedId.value) {
  ...
  try {
    ...
    error.value = formatApiError(e, t.value.chatMessagesLoadFailed, apiErrorCopy.value)
  } finally {
    loadingThread.value = false
  }
}
...
async function loadOlder() {
  ...
  try {
    ...
    error.value = formatApiError(e, t.value.chatOlderMessagesLoadFailed, apiErrorCopy.value)
  } finally {
...
async function loadMedia(id = selectedId.value) {
  ...
  try {
    ...
    error.value = formatApiError(e, t.value.chatMediaLoadFailed, apiErrorCopy.value)
  }
}
...
async function editMessage(message: ChatMessage) {
  ...
  try {
    ...
    error.value = formatApiError(e, t.value.chatMessageEditFailed, apiErrorCopy.value)
  }
}
...
async function removeMessage(message: ChatMessage) {
  ...
  try {
    ...
    error.value = formatApiError(e, t.value.chatMessageRemoveFailed, apiErrorCopy.value)
  }
}
...
async function sendText() {
  ...
  try {
    ...
    pendingMessageError.value = formatApiError(e, t.value.chatMessageSendFailed, apiErrorCopy.value)
    error.value = formatApiError(e, t.value.chatMessageSendFailed, apiErrorCopy.value)
  } finally {
...
async function processAttachment(id: string) {
  ...
  try {
    ...
    item.status = 'failed'
    item.error = formatApiError(e, t.value.chatAttachmentSendFailed, apiErrorCopy.value)
  } finally {
    processNextInAttachmentQueue()
  }
}
...
async function openAttachment(attachmentId: string) {
  ...
  try {
    ...
    error.value = formatApiError(e, t.value.chatDownloadFailed, apiErrorCopy.value)
  }
}
...
async function openInlineImage(attachment: ChatAttachment) {
  ...
  try {
    ...
    error.value = formatApiError(e, t.value.chatViewFailed, apiErrorCopy.value)
  }
}
