    ...
    <section class="card section identity" aria-labelledby="profile-identity-heading">
      <div class="identity-row">
        <div class="avatar-uploader">
          ...
          <span v-else class="avatar" :role="avatarFailed ? 'img' : undefined" :aria-label="avatarFailed ? (auth.user?.displayName || avatarCopy.avatarAlt) : undefined" :aria-hidden="avatarFailed ? undefined : 'true'">{{ initials }}</span>
