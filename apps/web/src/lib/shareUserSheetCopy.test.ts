...
import { shareUserSheetCopy } from './shareUserSheetCopy'

describe('shareUserSheetCopy', () => {
  it('provides Vietnamese user-share form, success, and error labels', () => {
    expect(shareUserSheetCopy('vi')).toEqual({
  ...
  it('provides English user-share form, success, and error labels', () => {
    expect(shareUserSheetCopy('en')).toEqual({
